                ...
                <Row>
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input type="text" name="emp_code" id="emp_code" value={formData.emp_code} onChange={handleChange} required />
                    </FormGroup>
                  </Col>
                  <Col md={6}>
                    <FormGroup>
                ...
                <Row>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input type="date" name="hire_date" id="hire_date" value={formData.hire_date} onChange={handleChange} required />
                    </FormGroup>
                  </Col>
                </Row>
                <Row>
                  ...
                  <Col md={6}>
                    <FormGroup>
                      ...
                      <Input type="text" name="position_id" id="position_id" value={formData.position_id} onChange={handleChange} required />
                    </FormGroup>
                  </Col>
                </Row>
                <Row>
